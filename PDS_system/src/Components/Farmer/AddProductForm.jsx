...
const AddProductForm = () => {
  ...
  const handleSubmitForm = (e)=>{
    ...
    if(data.name === "" || data.quantity === "" || data.district === "" || data.state === "" 
        || data.pincode === "" || data.image === "" || data.unit === "" ){
    ...
    formData.append("image" , "https://res.cloudinary.com/dwlgkphss/image/upload/v1700228906/PDS_System/pplrrmfw5udwtmxake4b.png")
